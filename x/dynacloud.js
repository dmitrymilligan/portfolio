...
// Adapted from <http://www.perseus.tufts.edu/Texts/engstop.html>
 ...
 stopwords: [ "Math", "только", "удивительно", "полное", "самая", "соответственно", "поставив", "поставьте", "придайте", "добавьте", "избежать", "именно", "наше", "ваша", "возьмите", "всегда", "вторичное", "здесь", "такого", "введение", "вперед", "допустим", "острова", "новая", "примечания", "smith", "frank", "john", "helo1512", "наконец", "осталось", "объявляем", "затем", "вашего", "целью", "хотя", "стоит", "слишком", "следует", "причем", "появление", "нужно", "возможно", "конечно", "никогда", "нельзя", "поле", "вашу", "вашей", "можно", "автором", "многие", "современные", "всемирной", "поэтому", "helloWorld", "hello", "надежный", "чтобы", "итак", "зачем", "естественно", "России", "кстати", "теперь", "аргентинский", "поддержка", "существует", "эта", "этот", "некоторые", "модуль", "после", "также", "часто", "является", "ссылки", "каждая", "сколько", "есть", "лучшая", "лучший", "обратите", "кроме", "однако", "поскольку", "таким", "неудивительно", "лишняя", "другим", "достаточно", "попробуем", "когда", "почему", "очень", "большинство", "например", "справочное", "возможные", "применимо", "если", "пример", "описание", "a", "about", "above", "accordingly", "after",
...
jQuery.fn.dynaCloud = function(outElement) {
 ...
 return this.each(function() {
  ...
  if (jQuery.wordStats && jQuery.dynaCloud.wordStats) {
   ...
   var elems = jQuery(this).text().replace(/[^A-ZА-Я\xC4\xD6\xDCa-zа-я\xE4\xF6\xFC\xDF0-9_]/g, ' ').replace(jQuery.dynaCloud.stopwords, ' ').split(' ');
   var word = /^[a-zа-я\xE4\xF6\xFC]*[A-ZА-Я\xC4\xD6\xDC]([A-ZА-Я\xC4\xD6\xDC\xDF]+|[a-zа-я\xE4\xF6\xFC\xDF]{3,})/;
